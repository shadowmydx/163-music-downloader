...
var tX = function(bl, bDM) {
        try {
            ...
            if (bl === null )
                return bDM == "null";
            if (bl === undefined)
                return bDM == "undefined";
            return {}.toString.call(bl).toLowerCase() == "[object " + bDM + "]"
        } catch (e) {
            return !1
        }
    };
var test = function(bk, fF, uj) {
        if (!bk || !bk.length || !bm.gj(fF))
            return this;
        if (!!bk.forEach) {
            bk.forEach(fF, uj);
            return this
        ...
        for (var i = 0, l = bk.length; i < l; i++)
            fF.call(uj, bk[i], i, bk);
        return this
    };
var test1 = function(qr) {
        var bn = [];
        test(qr, function(nb) {
            bn.push(emj[nb])
        }
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        ...
        bHm: function(a, b, c, d, e, j, l, f) {
            for (var m = this.bHz, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function biDivideModulo(a, b) {
    ...
    function asrsea(d, e, f, g) {
        ...
        var d1,d2,d3,d4;
        function b(a, b) {
        d1 = CryptoJS.enc.Utf8.parse(b);
        d2 = CryptoJS.enc.Utf8.parse("0102030405060708");
        d3 = CryptoJS.enc.Utf8.parse(a);
        d4 = CryptoJS.AES.encrypt(d3, d1, {
            iv: d2,
...
var mdmd = ["色", "流感", "这边", "弱", "嘴唇", "亲", "开心", "呲牙", "憨笑", "猫", "皱眉", "幽灵", "蛋糕", "发怒", "大哭", "兔子", "星星", "钟情", "牵手", "公鸡", "爱意", "禁止", "狗", "亲亲", "叉", "礼物", "晕", "呆", "生病", "钻石", "拜", "怒", "示爱", "汗", "小鸡", "痛苦", "撇嘴", "惶恐", "口罩", "吐舌", "心碎", "生气", "可爱", "鬼脸", "跳舞", "男孩", "奸笑", "猪", "圈", "便便", "外星", "圣诞"];
